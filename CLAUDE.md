...
| Product taxonomy    | **Product Family is single-valued** per Product; **Segment** is first-class and M:N with Product; **Product Type** is first-class and shared across Segments, never duplicated per Segment; one primary Product Type initially. **Decided — not implemented.**     | [ADR-007](./docs/ADR/ADR-007-product-taxonomy-v2.md)                                                                                                                                                                                     |
| Product URLs        | **Canonical Product Detail URL is `/{locale}/products/{product-slug}`** — flat. Segment and Product Type are navigation/facet relationships, **never canonical URL ancestry**. **Decided — not implemented**: no product detail route or template exists yet.      | [ADR-007](./docs/ADR/ADR-007-product-taxonomy-v2.md)                                                                                                                                                                                     |
...
| [`docs/ADR/README.md`](./docs/ADR/README.md)                                                                                                                                                    | Decision log — ADR-001 through ADR-007                    |
