...
- **A separate *area*, not merely more pages.** It has its own route segment, its own layout, its own authentication boundary, and no SEO surface at all. It shares the codebase, not the page architecture.
